...
public class AutorController implements ErrorHandler {
	...
	private final String viewPath = "autores/";
	...
	public String index(ModelMap modeloDeAutores) {
		...
		return this.viewPath.concat("autores-list");
	}

	@GetMapping("/create")
	public String create() {

		return this.viewPath.concat("create-autor");
	...
	public String updateName(ModelMap model, @PathVariable("id") String id) {
		...
		try {
			...
			return this.viewPath.concat("update-autor");
